...
function tambah($koneksi)
{
    if (isset($_POST['input_konten'])) {
        ...
        $query_input = mysqli_query($koneksi, "INSERT INTO postingan VALUES('$id_user',md5('$id'),'$judul','$konten','$tanggal','$foto','$id_kategori')");

        if ($query_input) {
            echo '<script>alert("data berhasil di input")
            window.location.href="postingan_admin.php";
            window.history.back();
           
          </script>';
        } else {
            echo '<script>alert("data gagal di input")
            window.location.href="posting_admin.php";
          </script>';
        }
    }
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="postingan_admin.php?id=<?php echo $data['id_user'] ?>" class="btn btn-warning">Edit</a>
                                                            <a href="" class="btn btn-info">View</a>
                                                            <a href="postingan_admin.php?aksi=delete&id=<?php echo $data['id_postingan'] ?>" onclick="return confirm('Apakah anda yakin ingin menghapus?')" class="btn btn-danger">Hapus</a>
                                                        </td>
                                                    </tr>
                                            <?php
                                                    $no++;
