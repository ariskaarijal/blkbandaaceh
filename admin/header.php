        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content flex-grow">
                  ...
                  <p class="font-weight-light small-text"> The meeting is cancelled
                  </p>
                </div>
              </a>
              <div class="dropdown-divider"></div>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <div class="preview-icon bg-info"><i class="mdi mdi-email-outline mx-0"></i></div>
                </div>
                <div class="preview-item-content">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <?php if ($_SESSION['level'] == 'admin') { ?>
            ...
            <li class="nav-item">
              <a class="nav-link" href="postingan_admin.php">
                <i class="menu-icon mdi mdi-television"></i>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="kategori.php">katagori</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="biodata_admin.php">
                <i class="menu-icon mdi mdi-backup-restore"></i>
          ...
          <?php } else if ($_SESSION['level'] == 'user') { ?>
            ...
            <li class="nav-item">
              <a class="nav-link" href="postingan_user.php">
                <i class="menu-icon mdi mdi-television"></i>
                <span class="menu-title">postingan</span>
              </a>
            </li>
