...
function tambah($koneksi)
{
    if (isset($_POST['input_biodata'])) {
        ...
        $format = explode(".", $foto);
        $fileEkstension = end($format);
        $nama_sementara = $_FILES['foto']['tmp_name'];
        $md5file = md5($foto) . "." . $fileEkstension;
                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_array($query)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="biodata_admin.php?aksi=update&id=<?php echo $data['id_biodata']; ?>&nama=<?php echo $data['nama']; ?>&tanggal=<?php echo $data['tanggal_lahir']; ?>&tempat=<?php echo $data['tempat_lahir']; ?>&jk=<?php echo $data['jenis_kelamin']; ?>&alamat=<?php echo $data['alamat']; ?>&id_user=<?php echo $data['id_user'] ?>" class="btn btn-warning">Edit</a>
                                                        <a href="biodata_admin.php?aksi=delete&id=<?php echo $data['id_biodata']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus?')" class="btn btn-danger">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php
                                                $no++;
